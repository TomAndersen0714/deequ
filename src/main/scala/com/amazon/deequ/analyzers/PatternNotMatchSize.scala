...
case class PatternNotMatchSize(column: String, pattern: Regex, where: Option[String] = None)
  extends StandardScanShareableAnalyzer[NumMatches]("PatternNotMatchSize", column)
